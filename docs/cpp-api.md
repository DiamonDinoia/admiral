...
[examples/](https://github.com/DiamonDinoia/yafft/tree/master/examples/), built and run by ctest.
...
expects. [example](https://github.com/DiamonDinoia/yafft/blob/master/examples/quickstart.cpp)
...
(last axis shrinks to `n/2 + 1`): [example](https://github.com/DiamonDinoia/yafft/blob/master/examples/real_transforms.cpp)
...
[example](https://github.com/DiamonDinoia/yafft/blob/master/examples/r2r_dct.cpp)
...
chaining every axis equals `plan<T>(shape)`. [example](https://github.com/DiamonDinoia/yafft/blob/master/examples/axis_transform.cpp)
...
C: [usage.md](usage.md#c) with [examples/c_api.c](https://github.com/DiamonDinoia/yafft/blob/master/examples/c_api.c).
FFTW: [usage.md](usage.md#fftw) with [examples/fftw_dropin.c](https://github.com/DiamonDinoia/yafft/blob/master/examples/fftw_dropin.c).
