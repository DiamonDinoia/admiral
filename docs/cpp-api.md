...
[../examples/](../examples/), built and run by ctest.
...
overloads for out-of-place work. [example](../examples/quickstart.cpp)
...
(last axis shrinks to `n/2 + 1`): [example](../examples/real_transforms.cpp)
...
chaining every axis equals `plan<T>(shape)`. [example](../examples/axis_transform.cpp)
...
C: [usage.md](usage.md#c) with [../examples/c_api.c](../examples/c_api.c).
FFTW: [usage.md](usage.md#fftw) with [../examples/fftw_dropin.c](../examples/fftw_dropin.c).
